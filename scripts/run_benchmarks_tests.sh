...
BENCHMARK_TESTS_DIR="$PROJECT_ROOT/tests/benchmark"
...
print_header "Running Automated Performance Tests"
echo "Running pytest for performance tests..."
pytest "$PROJECT_ROOT/tests/performance"
